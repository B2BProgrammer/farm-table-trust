...
NODE_ENV=local node fabric-cli.js chaincode install --src-dir ${CC_SRC_DIR} --index-dir ${CC_IND_DIR} --org org1 --cc-version V1 --channel $CHANNEL_NAME --cc-name $CC_NAME
#Install chaincode org2
NODE_ENV=local node fabric-cli.js chaincode install --src-dir ${CC_SRC_DIR} --index-dir ${CC_IND_DIR} --org org2 --cc-version V1 --channel $CHANNEL_NAME --cc-name $CC_NAME
